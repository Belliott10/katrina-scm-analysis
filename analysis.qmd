...
Table 1: Model Fit Diagnostics \dotfill (see Pre-Treatment Fit section)
...
Figure 1: Naive Comparison - New Orleans vs Donor Pool Average \dotfill \pageref{fig-naive}
...
Figure 5: Observed vs Synthetic Employment Rate \dotfill \pageref{Employment Levels}

Figure 6: In-Time Placebo Test \dotfill \pageref{fig-placebo}

Figure 7: In-Space Placebo Test \dotfill (page varies - external image)
